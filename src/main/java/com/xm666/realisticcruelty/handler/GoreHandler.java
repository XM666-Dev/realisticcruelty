...
public class GoreHandler {
    ...
    public static void onLivingDamage(LivingDamageEvent.Post event) {
        ...
        gore(hitType, targetEntity, sourceEntity, amount);
    }

    public static void gore(HitType hitType, LivingEntity target, Entity source, float amount) {
        ...
        var payload = new GorePayload(hitTypeOrdinal, targetBoundingBoxMin, targetBoundingBoxMax, sourcePosition, sourceDirection, amount);
    ...
    public static void handlePayload(final GorePayload payload, final IPayloadContext context) {
        ...
        ParticleHandler.gore(hitInfo, amount);
    }
}
